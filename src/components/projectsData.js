export const projects = [
  {
    ...
    description: "A modern full-stack smartphone e-commerce app with a clean, responsive UI, enabling users to browse products, view details, and manage their cart effortlessly.",
